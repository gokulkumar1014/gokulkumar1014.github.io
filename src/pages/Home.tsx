...
const Home: React.FC = () => {
    return (
        <div className="flex flex-col">
            ...
            {/* "What I Do" Section */}
            <Section className="bg-white/40 backdrop-blur-xl rounded-3xl md:rounded-[3rem] my-10 mx-auto w-full shadow-sm border border-white/50 p-6 md:p-16 relative overflow-hidden">
